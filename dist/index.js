...
server.tool("submit_review", "Submit a review of an API after using it. Closes the agent-feedback loop on CLIRank - your integration data improves the score for the next agent that searches. Use AFTER you've actually called the API for a real task. Be honest, even if it went badly.", {
